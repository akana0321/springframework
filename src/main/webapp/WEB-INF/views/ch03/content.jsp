...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
               const param1 = document.form1.param1.value;			 		<%-- name으로 접근 --%>
               const param2 = document.querySelector("#param2").value;		<%-- id로 접근: Element 리턴 --%>
               const param3 = $("#param3").val();							<%-- id로 접근: jQuery, jQuery 객체 리턴 --%>
               ...
               $.ajax({
                  url:"method1",
                  method:"get",
                  <%-- 속성 이름과 변수이름이 같을 경우에는 하나만 작성해도 된다 --%>
                  data: {
                     param1:param1, 
                     param2, 
                     param3, 
	   ...
	   <div class="card m-2">
	         ...
	         <div class="card-body">
	         	<a href="method3?param2=문자열2" class="btn btn-info btn-sm">요청</a>
	         </div>
	   </div>
